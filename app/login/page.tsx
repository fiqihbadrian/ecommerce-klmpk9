  ...
  return (
    ...
    >
      ...
      <div className="relative flex-shrink-0 px-4 pt-4" style={{ height: "180px" }}>
        ...
        <Link href="/welcome" className="flex items-center gap-1 transition-opacity duration-200 hover:opacity-80">
      ...
      <div
        className="flex-1 rounded-t-[40px] bg-white px-6 pt-10 pb-8 shadow-[0_-6px_34px_rgba(0,0,0,0.18)]"
      >
        {/* Title */}
        <h1
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-end -mt-1">
            <Link
              ...
              className="text-xs font-bold text-gray-700 transition-opacity duration-200 hover:opacity-80"
            >
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            ...
            className="w-full rounded-full py-4 text-base font-semibold text-white shadow-[0_10px_18px_rgba(75,85,99,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_22px_rgba(75,85,99,0.24)] disabled:translate-y-0 disabled:opacity-70 disabled:shadow-[0_10px_18px_rgba(75,85,99,0.18)]"
            style={{
        ...
        <p className="text-center text-xs font-bold text-gray-700">
          ...
          <Link href="/register" className="font-bold text-gray-800 transition-opacity duration-200 hover:opacity-80">
            Sign up!
          </Link>
        </p>
      </div>
